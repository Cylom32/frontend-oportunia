...
fun ButtonSectionSettings() {
    Column(
        ...
        Button(
            ...
            modifier = Modifier
                .fillMaxWidth(0.95f)
                .height(90.dp), // Reducimos la altura para que sea consistente con los otros botones
        ...
        Button(
            ...
            shape = RoundedCornerShape(12.dp), // Añadimos la misma forma que el botón "Cuenta"
